...
\begin{document}
  ...
  \section{Basic Graph algorithms}
    ...
    \subsection{Triconnected components*}
  ...
  \section{Flow and Matching Algorithms}
    ...
    \subsection{Circulation Reductions*}
    
    \subsection{Hopcorft-Karp algorithm*}
  ...
  \section{Computational geometry}
    ...
    \todo{Consider Java built-in geometry (Area etc.)}
    \todo{Maybe add some formulas for volumes, area etc.}
