...
{Note that the tree is implicit, though it can be un-implicited quite easily. The indices are zero-based. Also, don't forget to initialise the empty tree to \texttt{NULL}. (Pretty much) all operations take $O(\log n)$ time.}
