...
\begin{document}
  ...
  \section{Graph algorithms}
    ...
    Compute by defining $L_v$ to be the length of the longest chain ending at $v$. Sort $S$ topologically and use bottom-up DP to compute the $L_u$ for all $u \in S$.
    \end{description}
