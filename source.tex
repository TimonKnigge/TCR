...
\begin{document}
  ...
  \section{Helpers}
    ...
    \entry{Golden Section Search}{For a discrete search: use binary search on the difference of successive elements.}{snippets/helpers/goldensectionsearch.cpp}{$O(\log_2 {1 / \epsilon})$}{}
