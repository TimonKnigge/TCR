...
\lstset{emph=[1]{pair,vector,map,queue,priority\_queue,greater,
                 ...
                 FlowNetwork,edge,cmpx},
        emphstyle=[1]{\color{usertype}},
        emph=[2]{INF,LLINF,EPSILON,RES\_PHI,\_MSC\_VER,popcount,MAXV,M\_PI},
...
\begin{document}
  ...
  \section{Mathematics}
    ...
    \entry{Fast Fourier Transform}{Calculates the discrete convolution of two vectors. Note that the method accepts and outputs complex numbers, and the input is changed in place.}{snippets/mathematics/fft.cpp}{$O(n \log_2 n)$}{Bitmasking}
