...
\begin{document}
  ...
  \section{Miscellaneous}
    ...
    \entry{Longest Increasing Subsequence}{Finds the longest strictly increasing subsequence. To find the longest non-decreasing subsequence, insert pairs $(a_i, i)$}{snippets/misc/lis.cpp}{$O(n \log_2 n)$}{}
