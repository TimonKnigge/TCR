...
\begin{document}
  ...
  \section{Data Structures}
    ...
    \entry{Fenwick Tree}{The tree is 1-indexed! Use indices $1..n$.}{snippets/datastructures/fenwick.cpp}{}{}
  ...
  \section{Graph algorithms}
    ...
    \begin{descrption}
    \item[Number of distinct spanning trees]: Define the $V \times V$ matrix $M$ as: $M_{ij} = deg(i) if i = j$, $M_{ij} = -1 if \{i, j\} \in E$, $M_{ij} = 0$ otherwise. Then the number of distinct spanning trees equals $\det(M_{11})$.
    \end{description}
