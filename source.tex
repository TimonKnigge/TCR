...
{\Large Team Code Reference}
  ...
  \section{Basic Graph algorithms}
    ...
    \entry{Centroid Decomposition}{Finds the centroid decomposition of a tree. In case it's necessary to work with the subtrees directly, consider timestamping them.}{snippets/graphs/centroid.cpp}{$O(n \log_2 n)$}{}
