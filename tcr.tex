...
\entry{Dominator Set}{}{./snippets/datastructures/dominating-set.cpp}
...
{Fast in practice, can do min cost matching upto $n=1000$.}
{snippets/flowalgorithms/mcmf-circulation.cpp}
